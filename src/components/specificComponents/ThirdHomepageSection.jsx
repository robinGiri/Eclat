            ...
            <div className="bg-neutral-50 ">
                ...
                <div className="px-12 pb-10 bg-white">
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        >
                            <p className="font-bold text-6xl p-4 bg-yellow-400 flex justify-center">Clothing</p>
                         ...
                         <div
                            ...
                            onClick={() => console.log("Div 1 clicked")}
                        >
                            <p className="font-bold text-6xl p-4 bg-orange-400 flex justify-center">Cosmetics</p>
                         ...
                         <div
                            ...
                            onClick={() => console.log("Div 1 clicked")}
                        >
                            <p className="font-bold text-6xl p-4 bg-teal-900 flex justify-center">Electronics & Watches</p>
